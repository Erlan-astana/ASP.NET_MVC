    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Search_Method(int ValueSubject,string ValueClass,string ValueData)
        {
            ...
            try
            {
                ...
                if (ValueData == "") {
                    ...
                    SqlZapros = "SELECT TBL_ASSESSMENTS.ID, TBL_ASSESSMENTS.SUBJECT_ID , TBL_ASSESSMENTS.STUDENS_ID,TBL_ASSESSMENTS.DATE , TBL_ASSESSMENTS.ASSESSMENT,  TBL_ASSESSMENTS.CLASS_NAME  ,TBL_STUDENS.ID,TBL_STUDENS.FIO, TBL_STUDENS.CLASS_NAME FROM  TBL_ASSESSMENTS INNER JOIN TBL_STUDENS ON  TBL_ASSESSMENTS.STUDENS_ID =  TBL_STUDENS.ID WHERE TBL_ASSESSMENTS.SUBJECT_ID LIKE '" +
                         ValueSubject + "' AND TBL_ASSESSMENTS.CLASS_NAME  LIKE '" + ValueClass + "' ";
                }
                else
                {
                    SqlZapros = "SELECT  TBL_ASSESSMENTS.ID, TBL_ASSESSMENTS.SUBJECT_ID ,TBL_ASSESSMENTS.STUDENS_ID, TBL_ASSESSMENTS.DATE , TBL_ASSESSMENTS.ASSESSMENT,  TBL_ASSESSMENTS.CLASS_NAME  ,TBL_STUDENS.ID,TBL_STUDENS.FIO, TBL_STUDENS.CLASS_NAME FROM  TBL_ASSESSMENTS INNER JOIN TBL_STUDENS ON  TBL_ASSESSMENTS.STUDENS_ID =  TBL_STUDENS.ID WHERE TBL_ASSESSMENTS.SUBJECT_ID LIKE '" +
                         ValueSubject + "' AND TBL_ASSESSMENTS.CLASS_NAME  LIKE '" + ValueClass + "' AND TBL_ASSESSMENTS.DATE LIKE '" + ValueData + "'";
        ...
        public ActionResult insert_Jurnal(int SUBJECT_ID, string CLASS_NAME, int STUDENS_ID, string DATE, string ASSESSMENT)
        {
            ...
            try
            {
                ...
                var Jurnal_new = new TBL_ASSESSMENTS()
                {
                ...
                con.TBL_ASSESSMENTS.Add(Jurnal_new);           
                con.SaveChanges();
        ...
        public ActionResult Update_Jurnal(int ID, int SUBJECT_ID, string CLASS_NAME, int STUDENS_ID, string DATE, string ASSESSMENT)
        {
            ...
            try
            {
                ...
                var record = con.TBL_ASSESSMENTS.Find(ID);
        ...
        public ActionResult Del_Jurnal(int ID)
        {
            ...
            try
            {
                var row = con.TBL_ASSESSMENTS.Find(ID);
                con.TBL_ASSESSMENTS.Remove(row);
        ...
        public ActionResult get_ValueSubject()
        {
            ...
            try
            {
                string sqlQuery = "select * from DIC_SUBJECTS ";
                var items = con.Database.SqlQuery<DIC_SUBJECTS>(sqlQuery).ToList();
                return Json(items);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult insert_subject(string val_subject) {
            ...
            try
            {
                var subject_new = new DIC_SUBJECTS()
                {
                    NAME = val_subject,
                };

                con.DIC_SUBJECTS.Add(subject_new);
                con.SaveChanges();
        ...
        public ActionResult del_subject(int ID)
        {
            ...
            try
            {
                var row = con.DIC_SUBJECTS.Find(ID);
                con.DIC_SUBJECTS.Remove(row);
                int cnt = con.SaveChanges();
        ...
        public ActionResult TBL_TEACHERS() {

            return View();
        
        }
        public ActionResult insert_tbl_teacher(string FIO, string LOGIN, string PASSWORD, string SUBJECTS)
        {
            Dictionary<string, object> list = new Dictionary<string, object>();
            ...
            try
            {
                ...
                var NEW_TBL_TEACHER = new TBL_TEACHERS()
                {
                ...
                con.TBL_TEACHERS.Add(NEW_TBL_TEACHER);
                con.SaveChanges();
        ...
        public ActionResult get_ValueTeacher()
        {

            try
            {
                string sqlQuery = "select * from TBL_TEACHERS ";
        ...
        public ActionResult update_tbl_teacher(int ID, string FIO, string LOGIN, string PASSWORD, string SUBJECTS)
        {
            Dictionary<string, object> list = new Dictionary<string, object>();
            try
            {
                ...
                var record = con.TBL_TEACHERS.Find(ID);
                record.UDATE = DateTime.Now;
                record.FIO = FIO;
        ...
        public ActionResult del_TBL_TEACHER(int ID)
        {

            Dictionary<string, object> list = new Dictionary<string, object>();
            try
            {
                var row = con.TBL_TEACHERS.Find(ID);
                con.TBL_TEACHERS.Remove(row);                
                con.SaveChanges();
