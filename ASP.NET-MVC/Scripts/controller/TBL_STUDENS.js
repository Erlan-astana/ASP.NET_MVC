$(function () {
    ...
    function cmbx_Class() {
        ...
        app.cmbx_Class = $('.cmbx_Class').kendoComboBox({
            dataTextField: "NAME",
            dataValueField: "ID",
    ...
    function saveRecord() {
        ...
        try { if ($('.INP_FIO').val() == "" || $('.INP_LOGIN').val() == "" || $('.INP_PASSWORD').val() == ""
             || $('.INP_PHONE_NUMBER').val() == null || $('.INP_PHONE_NUMBER').val() == "" || CLASS_NAME == "" || CLASS_NAME == undefined || CLASS_NAME == null )
        {
        ...
        { 
            if (app.editMode == "add") {
                ...
                $.post(rootUrl + 'Home/update_TBL_STUDENS', {
                    ...
                    PASSWORD: $('.INP_PASSWORD').val(),
                    PHONE_NUMBER: $('.INP_PHONE_NUMBER').val(),               
                    // CLASS_NAME: $('.cmbx_Class').val()  не получится
                    CLASS_NAME: CLASS_NAME,
                    //app.cmbx_Class.value(),
